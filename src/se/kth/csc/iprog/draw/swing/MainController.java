...
public class MainController {
    public static void main(String[] argv) {
        ...
        // create a row of buttons with the same action listeer that distinguishes betwen them based on the name
        JComponent panel = new MainPanelCreator().createPanel(new String[] { "New canvas", "New form" },
            new ActionListener() {

                @Override
                public void actionPerformed(ActionEvent e) {
                    if (((AbstractButton) e.getSource()).getName().contains("canvas")) {
