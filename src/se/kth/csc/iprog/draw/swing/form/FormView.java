...
/**
 * The form view. Builds the whole view. Reads the shapes from the model, fills them in a list and show the properties
 * of the selected one.
 */
public class FormView extends JPanel implements Observer {
    ...
    // The model representation for the JList. This is different from the main model, and is observed just by the JList.
    // See Swing Separable Model Architecture.
    ...
    /**
     * The constructor that adds this view to the model's list of observers, and lays out the view components (list and
     * text fields). Called by the controller.
     */
    ...
    /** separated method for code legibility */
    ...
    /**
     * This method is needed so the observer doesn't remain hanged when e.g. the form is not visible any longer.
     */
    public void close() {
    ...
    /**
     * Called by the controller. Updates the form input controls to represent the values of currently selected shape. If
     * no shape is selected, the form is disabled.
     */
    ...
    /**
     * Called by the controller. Show the error message.
     */
