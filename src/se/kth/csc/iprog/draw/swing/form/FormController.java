...
/**
 * The form controller. Display the form view. Reacts to selection event in the
 * list of shapes and action (edit) event on the form controls.
 * 
 */
public class FormController implements ListSelectionListener, ActionListener {
	...
	/**
	 * a value has changed in one of the text fields, try to update the model
	 * and display the error message if it fails
	 * 
	 */
	@Override
